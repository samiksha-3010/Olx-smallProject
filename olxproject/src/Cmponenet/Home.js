...
<p style={ {color:"green",fontSize:"12px", marginBottom:"10%"}}>     
  ...
  <div className='meedleSection'>
 

    <div className='inner-section'>
      <div>
        <img src='https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQyqvxat3RXpxOZbab2ZvxSRJyHyakspFvuuyYHN1clNEYVGc2Io9180ihXzck&usqp=CAI'/>

      </div>
      <div>
        <img src='https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTgPoZ2bAHp4VH6KIXmgch0xdlM-7XLDyyZvv3G7aA7JtPJgmol6mK5MN2z1A&usqp=CAI'/>

      </div>
      <div>
        <img src='https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQi1rjDYK3508xwANg5YmzbGcEyxPY6lqTshwSqW9nmEYadwVjJAOtzD0iMYQ&usqp=CAI'/>

      </div>
      <div>
        <img src='https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTukOxgIhpAiqo1Prywf6TcJHdPiUnDMOlPcSPIkMbYf4UvW5lPKA7NigZ9CyU&usqp=CAI'/>
      ...
      <div>
        <img src='https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQYtMgLkB_ZLQ7_7hHNmmeOuF3hwqwrQ7qUgd7pRKAE25W8EZfcrMv791iE6Q&usqp=CAI'/>
...
{/* <div className='last-section'>
  <div className='image-section'>  image  </div>
    ...
    <div className='meedle'>
      <h2>TRY THE OLX APP</h2>
      <p>Buy, sell and find just
         about anything<br/> using the app on your mobile.</p>
         </div>
      <div className='meedle-image'>


        <p>GET YOUR APP TODAY</p><br/>

        <img src='https://pluspng.com/img-png/play-store-logo-png-google-play-logo-google-play-app-store-android-google-play-free-910x528.png' style={{width:"40%"}}/> 
      </div>
</div> */}
